...
$commentaires = getCommentairesValides();

if(!$commentaires) {
    echo "Il n'y a aucun commentaire validé.";
}
?>
    ...
    <table class="table">
        ...
        <tbody id="revendeurs">
            ...
            foreach ($commentaires as $commentaire) {
                ...
                $tableau .= '<th><button type="button" class="btn btn-primary suppression_commentaire" id="' . $commentaire['id'] . '">Supprimer</button></th>';
                $tableau .= '</tr>';
            }
            echo $tableau;
            ?>

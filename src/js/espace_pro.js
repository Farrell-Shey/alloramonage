...
//       /*$("#mot_de_passe_verif").after(
//         "<span id='email_erreur' class='text-danger'>Pas bon mdp</span>"
//       );*/
//       e.preventDefault();
//     } else {
//       $("#texte_erreur_mdp").text("");
//       $("#mot_de_passe_verif").after("<span id='email_erreur' class='text-danger'>Pas bon mdp</span>").remove();
//     }
//   });
// });
